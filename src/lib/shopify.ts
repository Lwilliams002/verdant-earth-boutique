...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "ndkugy-pp.myshopify.com";
...
export async function fetchShopifyProducts(first = 100, query?: string): Promise<ShopifyProduct[]> {
