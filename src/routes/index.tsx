...
import sideVineAsset from "@/assets/plants/side-vine.png.asset.json";
import sectionLeavesAsset from "@/assets/section-leaves.png.asset.json";
import collectionHerbsAsset from "@/assets/collection-herbs.png.asset.json";
const botanicalBg = botanicalBgAsset.url;
const sideVine = sideVineAsset.url;
const sectionLeaves = sectionLeavesAsset.url;
const collectionHerbs = collectionHerbsAsset.url;
